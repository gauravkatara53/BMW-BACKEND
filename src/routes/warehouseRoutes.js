...
//  order detail
router
  .route('/get/warehouse/order/status/:id')
  .get(verifyJWTPartner, checkCurrentUserWarehouse);

router
  .route('/get/warehouse/order/history/:id')
  .get(verifyJWTPartner, historyListWarehouse);
